...
DictWS_path = './Results Single Integrator/Results {}/DictWS/'.format(test_set)                             # DictWS path
...
x_init_max = np.array([ 15,  15, (NSTEPS-1)*dt])                                                            # State upper bound initial configuration array
...
# {'test_n': 0, 'seed': 0, 'system_id': 'single_integrator', 'recover_training_flag': False, 'nb_cpus': 15, 'w_S': 0.01, 'GPU_flag': False}