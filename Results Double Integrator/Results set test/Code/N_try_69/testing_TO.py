    ...
    def test_TO_Solve(self):
        ...
        for ep in range(1):
            ...
            for i in range(conf.EP_UPDATE):
                ...
                results_tf = TrOp_tf.TO_Solve(init_rand_state_tf_return, init_TO_states_tf, init_TO_controls_tf, NSTEPS_SH_tf)
                results_torch = TrOp_torch.TO_Solve(init_rand_state_torch_return, init_TO_states_torch, init_TO_controls_torch, NSTEPS_SH_torch)
