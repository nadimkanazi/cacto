...
class TestRLAC(unittest.TestCase):
    ...
    def test_learn_and_update(self):
        ...
        def compute_sample_torch(args):
            ...
            # Create initial TO #
            init_rand_state, init_TO_states, init_TO_controls, NSTEPS_SH, success_init_flag = self.tl_torch.create_TO_init(ep, ICS)
            if success_init_flag == 0:
                return None
            ...
            # Collect experiences 
            state_arr, partial_reward_to_go_arr, total_reward_to_go_arr, state_next_rollout_arr, done_arr, rwrd_arr, term_arr, ep_return, RL_ee_pos_arr  = self.tl_torch.RL_Solve(TO_controls, TO_states, TO_step_cost)
