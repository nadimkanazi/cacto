...
class WeightedMSELoss(torch.nn.Module):
    ...
    def forward(self, inputs, targets, weights=None, reduction='sum_over_batch_size'):
...
def compute_critic_grad_torch(critic_model, target_critic, state_batch, state_next_rollout_batch, partial_reward_to_go_batch, dVdx_batch, d_batch, weights_batch):
        ...
        if w_S != 0:
            ...
            print(f'der_critic_value_torch: {der_critic_value}')
            ...
            critic_loss_v = othermse(reward_to_go_batch, critic_value)
            #print(f'critic_loss_v_torch: {critic_loss_v}')
